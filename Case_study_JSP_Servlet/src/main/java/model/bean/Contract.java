...
public class Contract {
    ...
    public Contract(int contract_id, String contract_start_date, String contract_end_date, double contract_deposit, double contract_money, int employee_id, int customer_id, int service_id) {
